...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return Observe; });\n/* harmony import */ var _defineReactive__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./defineReactive */ \"./state/defineReactive.js\");\n// Observe类，观测数据变化\r\n\r\n\r\nlet id = 0;\r\nclass Observe {\r\n    constructor(value, tm) {\r\n        this.value = value;\r\n        this.id = id++;\r\n        this.tm = tm;\r\n        value.__ob__ = this;\r\n        Object.defineProperty(value, '__ob__', {\r\n            configurable: true,\r\n            enumerable: false,\r\n            value: this,\r\n            writable: true\r\n        });\r\n        if(!value._watchers) {\r\n            value._watchers = [];\r\n            Object.defineProperty(value, '_watchers', {\r\n                configurable: true,\r\n                enumerable: false\r\n            });\r\n        }\r\n\r\n        // TODO:一些逻辑\r\n        this.define();\r\n    }\r\n    define() {\r\n        const keys = Object.keys(this.value);\r\n\r\n        keys.forEach(key => {\r\n            Object(_defineReactive__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(this.value, key, this.tm);\r\n        })\r\n    }\r\n}\n\n//# sourceURL=webpack:///./state/observe.js?");
...
/*!***********************!*\
  !*** ./vdom/domFn.js ***!
  \***********************/
/*! exports provided: createElement, innerContent, insertText, appendChild, addEventListener, removeChild, createTextNode */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
